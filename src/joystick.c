...
/*
This function reads the input from the joystick
*/
uint8_t readJoystick(){

    uint8_t returnValue = 0; // Initialize return value
    ...
    // Adjust the return value depending on the values read from the joystick
    if (bit0 >= 1){
        returnValue = 1;
    }
    if (bit1 >= 1){
